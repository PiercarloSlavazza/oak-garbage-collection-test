...
import org.apache.jackrabbit.oak.stats.*;
...
import static org.apache.jackrabbit.oak.commons.FileIOUtils.*;
 ...
 *
 */
public class MarkSweepGarbageCollector2 implements BlobGarbageCollector {

    public static final Logger LOG = LoggerFactory.getLogger(MarkSweepGarbageCollector2.class);
     ...
     * @throws IOException
     */
    public MarkSweepGarbageCollector2(
